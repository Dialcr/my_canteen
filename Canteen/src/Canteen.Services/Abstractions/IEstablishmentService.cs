...
{
    PagedResponse<Dto.Establishment.EstablishmentOutputDto> GetAllEstablishments(int page, int perPage, int? category = null, bool useInactive = false);
    ...
    PagedResponse<EstablishmentOutputDto> GetMustPopularEstablishments(int page, int perPage);
